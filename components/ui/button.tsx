...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        locked:
          "bg-neutral-200 text-primary-foreground hover:bg-neutral-200/09 border-neutral-400 border-b-4 active:border-b-0",
        default:
        ...
        primaryOutline: "bg-white ext-cyan-500 hover:bg-slate-100",
        secondary:
          "bg-teal-500 text-primary-foreground hover:bg-teal-500/90 border-teal-600 border-b-4 active:border-b-0",
        secondaryOutline: "bg-white ext-teal-600 hover:bg-slate-100",
        danger:
        ...
        sidebarOutline:
          "bg-cyan-500/15 text-cyan-600 border-cyan-300 border-2 hover:bg-cyan-500/20 transition-none",
      },
      size: {
